 ...
 * 
    ...
    No método main, use a classe Scanner para permitir que o jogador insira 6 números. ok
    ...
    */
    public static void main(String[] args) {
        ...
        for (int i = 0; i < bilhete.getNumerosEscolhidos().length; i++) {
            System.out.print("Digite o " + (i + 1) + "º número: ");
            bilhete.setNumeroEscolhido(i, sc.nextInt());
            sc.nextLine();
