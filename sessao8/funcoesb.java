...
public class funcoesb {         
    ...
    public static void main(String[] args) {
        ...
        */
         ...
         * Como o System.eit termina o programa abruptamente, deve ser usado com cuidado, normalmente em situações de erro crítico ou quando não há mais nada a ser feito;
         * CASOS DE USO:
